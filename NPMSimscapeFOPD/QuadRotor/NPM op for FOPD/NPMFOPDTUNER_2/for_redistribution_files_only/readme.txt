...
================================
-run_NPMFOPDTUNER_2.sh (shell script for temporarily setting environment variables and 
 executing the application)
   -to run the shell script, type
   
       ./run_NPMFOPDTUNER_2.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v95, run the shell script as:
       ...
       ./run_NPMFOPDTUNER_2.sh /mathworks/home/application/v95
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_NPMFOPDTUNER_2.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure NPMFOPDTUNER_2.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r NPMFOPDTUNER_2.zip NPMFOPDTUNER_2.app
    or the tar command 
    tar -cvf NPMFOPDTUNER_2.tar NPMFOPDTUNER_2.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v95/runtime/maci64:MR/v95/sys/os/maci64:MR/v95/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_NPMFOPDTUNER_2.sh 
